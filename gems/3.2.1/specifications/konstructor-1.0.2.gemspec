...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<activesupport>.freeze, ["~> 4.2".freeze])
  s.add_development_dependency(%q<coveralls>.freeze, ["~> 0.8.19".freeze])
  s.add_development_dependency(%q<thor>.freeze, ["= 0.19.4".freeze])
  s.add_development_dependency(%q<contracts>.freeze, ["= 0.14.0".freeze])
  s.add_development_dependency(%q<constructor>.freeze, ["= 2.0.0".freeze])
end
